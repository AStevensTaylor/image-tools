...
export async function saveCachedDirectory(handle: FileSystemDirectoryHandle): Promise<void> {
  try {
...
export async function requestDirectory(useCache: boolean = true): Promise<FileSystemDirectoryHandle | null> {

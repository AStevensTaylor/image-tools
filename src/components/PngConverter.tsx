    ...
    <div className="h-full flex flex-col p-6">
      ...
      <div className="flex-1 flex flex-col gap-4 min-h-0">
        ...
        <div className="text-center text-sm text-muted-foreground">
          <p>Converts any image format to PNG with full quality and transparency preserved.</p>
          <p className="mt-1">Supported inputs: JPEG, WebP, GIF, BMP, SVG, AVIF, and more.</p>
        </div>
      </div>
    </div>
  );
